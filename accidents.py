...
def main():
    ...
    def askfile():
        ...
        try:
            ...
            print("You do not have the permission to edit that file. Please try again.\n")
            askfile()
        except:
            print("You done boinked. Try again, goofta.\n")
            askfile()
    ...
    with open(filename, "rt") as text_file:
        ...
        def askcpreduc():
            try:
                ...
                print("I don't even know what you did, but it was wrong.")
                askcpreduc()
            else:
